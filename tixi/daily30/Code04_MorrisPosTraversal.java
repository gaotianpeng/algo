...
/*
    Morris 遍历
        ...
        3）cur 为空时遍历停止
*/
public class Code04_MorrisPosTraversal {
    ...
    public static List<Integer> morrisPos(Node head) {
        if (head == null) {
            return null;
        }
    ...
    public static void printEdge(Node head, List<Integer> ans) {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < testTimes; ++i) {
            ...
            List<Integer> ans1 = morrisPos(tree);
